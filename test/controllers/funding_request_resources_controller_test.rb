...
class FundingRequestResourcesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funding_request_resource" do
    assert_difference("FundingRequestResource.count") do
      post funding_request_resources_url, params: { funding_request_resource: { funding_request_id: @funding_request_resource.funding_request_id, funding_resource_ammount: @funding_request_resource.funding_resource_ammount, funding_resource_type: @funding_request_resource.funding_resource_type } }
    end
  ...
  test "should update funding_request_resource" do
    patch funding_request_resource_url(@funding_request_resource), params: { funding_request_resource: { funding_request_id: @funding_request_resource.funding_request_id, funding_resource_ammount: @funding_request_resource.funding_resource_ammount, funding_resource_type: @funding_request_resource.funding_resource_type } }
