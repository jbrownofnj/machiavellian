class FundRequestResponsesController < ApplicationController
  ...
  # GET /fund_request_responses or /fund_request_responses.json
  def index
    @fund_request_responses = FundRequestResponse.all
    render json:@fund_request_responses
  end
  ...
  def create
    ...
    respond_to do |format|
      if @fund_request_response.save
        format.html { redirect_to fund_request_response_url(@fund_request_response), notice: "Fund request response was successfully created." }
