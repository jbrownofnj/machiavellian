class TradeRequestResourcesController < ApplicationController
  ...
  def index
    ...
    render json: @trade_request_resources
  end
  ...
  private
    ...
    def trade_request_resource_params
      params.require(:trade_request_resource).permit(:trade_request_id, :trade_request_resource_type, :trade_request_resource_quantity)
    end
end
